...
void ir_read(void) {
  ...
  if (irrecv.decode(&results)) {
    ...
    switch (code) {
      ...
      case S_EAST: mount_move(telescope, 's'); mount_move(telescope, 'e'); lastpresstime = millis(); ir_state = 1; break;
      case N_EAST: mount_move(telescope, 'n'); mount_move(telescope, 'e'); lastpresstime = millis(); ir_state = 1; break;
      case S_WEST: mount_move(telescope, 's'); mount_move(telescope, 'w'); lastpresstime = millis(); ir_state = 1; break;
      case N_WEST: mount_move(telescope, 'n'); mount_move(telescope, 'w'); lastpresstime = millis(); ir_state = 1; break;
      ...
      case TRACK: telescope->track = 1; break;
      case TRACK_OFF: mount_track_off(telescope); break;
      case B_1 : n = n * 10 + 1; break;
      case B_2 : n = n * 10 + 2; break;
      case B_3 : n = n * 10 + 3; break;
      case B_4 : n = n * 10 + 4; break;
      case B_5 : n = n * 10 + 5; break;
      case B_6 : n = n * 10 + 6; break;
      case B_7 : n = n * 10 + 7; break;
      case B_8 : n = n * 10 + 8; break;
      case B_9 : n = n * 10 + 9; break;
      case B_0 : n = n * 10; break;
      case GO_TO: if ((n < 111) && (n > 0)) {
    ...
    switch (last) {
      ...
      case S_EAST:  case N_EAST: case S_WEST: case N_WEST: mount_stop(telescope, 'w'); mount_stop(telescope, 's'); break;
